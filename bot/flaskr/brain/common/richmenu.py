    ...
    rich_menu_to_create = RichMenu(
        ...
        areas=[
            RichMenuArea(
                ...
                action=URIAction(uri="https://liff.line.me/1654371886-xorapzM6/liff/bookmark/", label="bookmark")
            ),
            RichMenuArea(
            ...
            RichMenuArea(
                ...
                action=URIAction(uri="https://liff.line.me/1654371886-xorapzM6/liff/history/", label="history")
            ),
            RichMenuArea(
